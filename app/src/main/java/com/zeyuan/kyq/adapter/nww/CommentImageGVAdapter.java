...
public class CommentImageGVAdapter extends BaseAdapter {
    ...
    public CommentImageGVAdapter(Context context, List<String> list, List<String> remarks, int pw){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            vh = new ViewHolder();
            convertView = LayoutInflater.from(context).inflate(R.layout.item_comment_image_gv, parent, false);
        ...
        String remark = remarks.get(position);
        if (!TextUtils.isEmpty(remark)){
            vh.tv.setVisibility(View.VISIBLE);
            vh.tv.setText(remark);
        } else {
            vh.tv.setVisibility(View.GONE);
        }
        return convertView;
